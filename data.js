  ...
  const maintenanceSchedule = {
    intervals: {
      ...
      15000: [
        ...
        {
          service: "Engine Air Filter Inspection",
          priority: "medium",
          price: 0,
          labor_hours: 0.1
        }
      ...
      30000: [
        ...
        {
          service: "Brake Fluid Inspection",
          priority: "medium",
          price: 0,
          labor_hours: 0.2
        },
      ...
      60000: [
        {
          service: "Spark Plug Replacement (4-cyl)",
          priority: "high",
          price: 249.95,
          labor_hours: 1.5
        },
      ...
      90000: [
        {
          service: "Differential Fluid Service (4WD/AWD)",
          priority: "high",
          price: 179.95,
          labor_hours: 0.8
        },
        {
          service: "Transfer Case Fluid (4WD)",
          priority: "medium",
          price: 149.95,
          labor_hours: 0.7
        }
      ...
      100000: [
        {
          service: "Timing Belt Replacement (if equipped)",
          priority: "critical",
          price: 899.95,
          labor_hours: 4.0
        },
      ...
      120000: [
        {
          service: "Spark Plug Replacement (V6)",
          priority: "high",
          price: 349.95,
          labor_hours: 2.0
        }
    ...
    modelSpecific: {
      RAV4: {
        ...
        60000: [
          {
            service: "Rear Differential Service (AWD)",
            priority: "high",
            price: 179.95,
            labor_hours: 0.8
          }
      ...
      Prius: {
        30000: [
          {
            service: "Hybrid Battery Cooling System Check",
            priority: "high",
            price: 89.95,
            labor_hours: 0.5
          }
      ...
      Tundra: {
        60000: [
          {
            service: "Spark Plug Replacement (V8)",
            priority: "high",
            price: 449.95,
            labor_hours: 2.5
          }
      ...
      "4Runner": {
        ...
        60000: [
          {
            service: "Rear Differential Service",
            priority: "high",
            price: 179.95,
            labor_hours: 0.8
          }
