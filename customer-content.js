...
(function () {
  ...
  const defaultContent = {
    ...
    neglect:
      "Delaying maintenance can allow normal wear or degraded fluid condition to continue. It does not guarantee a failure, but it can reduce the opportunity to address concerns early.",
  ...
  const byService = {
    "Oil & Filter Change": {
      ...
      neglect:
        "Extended oil use can increase contamination and reduce lubrication performance.",
    ...
    "Tire Rotation": {
      ...
      neglect:
        "Uneven wear may shorten tire life and require replacement sooner.",
      source: "Toyota scheduled maintenance"
    },
    "Multi-Point Inspection": {
      icon: "🔎",
      benefit:
        "Creates an early snapshot of wear, fluid condition, and safety-related items.",
      ...
      neglect:
        "Skipping inspections can delay discovery of leaks, wear, or damage.",
      source: "Inspection result"
    },
    "Cabin Air Filter": {
      icon: "🌬️",
      benefit:
        "Supports clean airflow through the vehicle's climate-control system.",
      ...
      neglect:
        "A heavily restricted filter may reduce airflow and allow more debris into the HVAC housing.",
    ...
    "Engine Air Filter Replacement": {
      ...
      neglect:
        "A restricted filter may reduce airflow and can contribute to reduced performance.",
      source: "Condition-based recommendation"
    },
    "Brake Fluid Inspection": {
      icon: "🛑",
      benefit:
        "Checks the condition of the fluid that transfers braking force hydraulically.",
      ...
      neglect:
        "Degraded or moisture-contaminated fluid may provide less corrosion protection and hydraulic performance.",
      source: "Inspection result"
    },
    "Brake Fluid Flush": {
      icon: "🛑",
      benefit:
        "Replaces aged brake fluid with fresh fluid for the hydraulic braking system.",
      ...
      neglect:
        "Old fluid may contain more moisture and provide less corrosion protection. Replacement does not repair mechanical brake problems.",
      source: "Dealership preventive-maintenance recommendation"
    },
    "Transmission Fluid Service": {
      icon: "⚙️",
      benefit:
        "Supports lubrication, cooling, and proper transmission operation.",
      ...
      neglect:
        "Fluid condition can degrade with heat and use. The exact service procedure should be verified for the vehicle.",
      source: "Verification required"
    },
    "Coolant Flush": {
      icon: "🌡️",
      benefit:
        "Restores coolant condition and corrosion protection in the engine cooling system.",
      ...
      neglect:
        "Aged coolant may provide less corrosion protection. Coolant service does not repair an existing overheating problem.",
      source: "Verification required"
    },
    "Hybrid Inverter Coolant Service": {
      ...
      neglect:
        "Aged coolant may provide less heat-transfer and corrosion protection. Applicability must be verified by model.",
      source: "Verification required"
    },
    "Hybrid Battery Cooling System Check": {
      ...
      neglect:
        "Restricted airflow may reduce cooling effectiveness. A dirty intake alone does not guarantee battery failure.",
      source: "Condition-based recommendation"
    },
    "Differential Fluid Service (4WD/AWD)": {
      ...
      neglect:
        "Old or contaminated lubricant may provide less wear protection.",
      source: "Dealership preventive-maintenance recommendation"
    },
    "Transfer Case Fluid (4WD)": {
      icon: "⚙️",
      benefit:
        "Maintains lubrication in the transfer case on applicable 4WD vehicles.",
      ...
      neglect:
        "Degraded lubricant may provide less protection under heat and load.",
      source: "Dealership preventive-maintenance recommendation"
    },
  ...
  function sparkPlugContent() {
    return {
      icon: "⚡",
      benefit:
        "Supports reliable ignition, smooth operation, and emissions performance.",
      ...
      neglect:
        "Worn plugs may contribute to hard starting, misfires, reduced performance, or catalyst stress.",
  ...
  function drivetrainInspectionContent() {
    return {
      icon: "🔎",
      benefit:
        "Checks applicable AWD or 4WD components for leaks, damage, and fluid concerns.",
